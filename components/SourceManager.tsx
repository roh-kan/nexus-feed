        ...
        <div className="space-y-1">
          {sources.length === 0 ? (
            ...
            sources.map((source) => (
              <div
                key={source.id}
                className="group flex items-center justify-between p-2 rounded-lg hover:bg-slate-800 transition-colors"
              >
                <div className="min-w-0">
                  ...
                  <div className="flex gap-1 mt-0.5">
                    {source.tags.slice(0, 2).map((t) => (
                      <span
                        key={t}
                        className="text-[10px] text-slate-500 truncate max-w-[60px]"
                      >
                        #{t}
                      </span>
                    ))}
